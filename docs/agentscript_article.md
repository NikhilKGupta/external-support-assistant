...
![Two-Phase Flow of Control](images/diagram_two_phase_flow.png)
...
## Step-By-Step Turn Walkthrough for the Example Conversation {Read this side by side with [code](agentscript.agent)}
...
![Trace](images/reasoning_span_trace.png)

![React Span Json](images/react_span.png)
...
~~**TLDR:**~~
~~While the action is wrapped in reasoning step prefixed by pipe, `|`, Language Model (used by reasoning planner) will decide, if it wants to execute that action or NOT (ergo, Non-Determinism)~~

---

## Appendix

- [Full Agentscript](agentscript.agent)
...
|---|---|---|---|
| Friday, March 6th | DRAFT | Nikhil Kumar Gupta | Initial document creation with basic AgentScript control flow concepts |
| Saturday, March 7th | DRAFT | Nikhil Kumar Gupta | Added Details and Examples. |
| Monday, March 9th | 1.0 | Nikhil Kumar Gupta | Added Diagrams |
| Saturday, April 11th | 2.0 | Nikhil Kumar Gupta | Explained Primitives. Added Step-By-Step Walkthrough per turn. Added user utterance, its effect on processing, and what the LLM actually sees. |
| Saturday, April 18th | 2.1 | Nikhil Kumar Gupta | Topics renamed to subagent. Updated the article. Updated code blocks. Updated diagrams. |
